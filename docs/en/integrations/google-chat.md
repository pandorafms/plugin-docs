...
Open a terminal window and access the Pandora FMS server. Download (and unzip) from the [Pandora FMS library](https://marketplace.pandorafms.com/google-chat-connector-cli/) the *Google Chat connector CLI* in the following path:
