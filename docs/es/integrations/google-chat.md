...
Abra una ventana terminal y acceda al servidor Pandora FMS. Descargue (y descomprima) desde la [librería de Pandora FMS](https://marketplace.pandorafms.com/google-chat-connector-cli/) el *Google Chat connector CLI* en la siguiente ruta:
